...
The FDX API includes 7 endpoints organized around <Tooltip tip={<span>Chariot is a financial technology company, not a bank. Banking services provided by Column N.A., Member FDIC. <a href="https://help.givechariot.com/onboarding/compliance-verification/chariot-deposit-accounts" target="_blank" rel="noreferrer">Full disclosure</a></span>}>deposit accounts</Tooltip>:
