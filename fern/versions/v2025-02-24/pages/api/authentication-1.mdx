...
<Aside>
  <CodeBlocks>
    ```curl
    curl https://api.givechariot.com/nonprofit/530196605 \
      -H "Authorization: Bearer sk_test_4eC39HqLyjWDarjtT1zdp7dc"
    ```
    ```csharp C#
    var client = new RestClient("https://api.givechariot.com/nonprofit/530196605");
    ...
    func main() {
      ...
      url := "https://api.givechariot.com/nonprofit/530196605"
    ...
    ```
    ```java Java
    HttpResponse<String> response = Unirest.get("https://api.givechariot.com/nonprofit/530196605")
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "https://api.givechariot.com/nonprofit/530196605",
    ...
    conn.request("GET", "/nonprofit/530196605", headers=headers)
    ...
    url = URI("https://api.givechariot.com/nonprofit/530196605")
