...
<Aside>
  ...
  - `account_transfer.created`: This event is triggered when an account transfer is created.
  - `account_transfer.updated`: This event is triggered when an account transfer is updated.
  - `ach_transfer.created`: This event is triggered when an ACH transfer is created.
  - `ach_transfer.updated`: This event is triggered when an ACH transfer is updated. This can happen when the status of the ACH transfer changes.
  - `check_transfer.created`: This event is triggered when a check transfer is created.
  - `check_transfer.updated`: This event is triggered when a check transfer is updated. This can happen when the status of the check transfer changes and when tracking updates are created for mailed checks.
</Aside>
