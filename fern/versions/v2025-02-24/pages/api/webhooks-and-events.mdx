...
<Aside>
  ...
  - `disbursement.updated`: This event is triggered when a disbursement is updated. This can happen when the status of the payment changes and when tracking updates are created for mailed checks.
</Aside>
