...
### Create Launch Plan
For fundraising platforms with multiple nonprofits, the [Create Nonprofit](/api/nonprofits/create) and [Create Connect](/api/connects/create) needs to be called once for each nonprofit on your platform. As part of development, you need to determine when and how these calls will be made for each nonprofit. 
