...
### Create Launch Plan
For fundraising platforms with multiple nonprofits, the [Create Nonprofit](/api/nonprofits/create) and [Create Connect](/api/connects/create)will be called one time for each nonprofit on your platform. As part of development, you will need to determine when and how these calls will be made for each nonprofit. 
