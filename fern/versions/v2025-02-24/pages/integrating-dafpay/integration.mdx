...
After you submit your own donation form, do not forget to call the [Create Grant](/api/grants/create) API to initiate the transaction.
</Warning>
...
3. Have your backend call Chariot's [Create Grant](/api/grants/create) API to initiate the grant (and capture the grant intent).
