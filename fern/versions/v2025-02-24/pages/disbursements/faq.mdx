...
<AccordionGroup>
    ...
    <Accordion title="What does the onboarding process look like for nonprofits?">
        ...
        <Steps>
            ...
            The nonprofit provides verifying information to Chariot to activate a DDA Account<span title="Chariot is a financial technology company, not a bank. Chariot Accounts come with a Demand Deposit Account through our banking services partner, Column N.A., Member FDIC. Deposits in Chariot Accounts are eligible for FDIC insurance up to $250,000 per depositor, for each insurable capacity in which the account is held."><sup><Icon icon="fa-regular fa-circle-info" size="2.5"/></sup></span>.
