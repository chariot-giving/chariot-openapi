...
If a nonprofit has a DDA Account<Icon icon="fa-regular fa-circle-info" size="2" /> with Chariot, they can receive payments electronically to their verified bank account.
...
If a nonprofit does not have a DDA Account<Icon icon="fa-regular fa-circle-info" size="2" /> with Chariot, they can still receive payments via Chariot's Disbursements.
