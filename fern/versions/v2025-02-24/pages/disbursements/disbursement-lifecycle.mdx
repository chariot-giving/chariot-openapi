...
<AccordionGroup>
    <Accordion title="Account Transfer">
        An Account Transfer happens when both the grant maker and receiving nonprofit have a Chariot Deposit Account<span title="Chariot is a financial technology company, not a bank. Chariot Accounts come with a Demand Deposit Account through our banking services partner, Column N.A., Member FDIC. Deposits in Chariot Accounts are eligible for FDIC insurance up to $250,000 per depositor, for each insurable capacity in which the account is held."><sup><Icon icon="fa-regular fa-circle-info" size="2.5"/></sup></span>. It is instant and can be sent 24 hours a day, 7 days a week.
