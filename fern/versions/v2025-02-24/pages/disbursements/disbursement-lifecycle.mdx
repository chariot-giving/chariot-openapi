...
<AccordionGroup>
    <Accordion title="Account Transfer">
        An Account Transfer happens when both the grant maker and receiving nonprofit organization have a Chariot Deposit Account.
        Account Transfers happen instantly and can be sent 24 hours a day, 7 days a week.
