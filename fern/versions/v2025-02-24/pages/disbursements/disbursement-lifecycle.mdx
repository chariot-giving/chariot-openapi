...
Additionally, it tracks if the Disbursement has been approved by the Chariot team.
...
| `rejected` | The check was rejected by Chariot before being submitted|
...
<AccordionGroup>
    <Accordion title="Book Transfer">
        A Book Transfer happens instantly and can be sent 24 hours a day, 7 days a week. If a nonprofit has an account with Chariot, Chariot will send funds using this payment rail.
