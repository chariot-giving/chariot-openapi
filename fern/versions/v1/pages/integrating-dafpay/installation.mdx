...
<Info> 
Make sure to add the Connect ID (cid) to the Chariot-Connect component. Remember, you only need to call the Create Connect route one time per nonprofit to generate this cid.
</Info>
