...
<AccordionGroup>
    ...
    Typically, this error means that the organization is no longer in good standing with the IRS or that they are a religious oganization that is not registered with the IRS directly.
    </Accordion>
</AccordionGroup>
