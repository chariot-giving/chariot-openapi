...
### Create Nonprofit
<Tip> 
This route requires the organization’s EIN and a unique email address.
...
For registration, it's necessary to supply the nonprofit's EIN and details for a contact person at the nonprofit.
