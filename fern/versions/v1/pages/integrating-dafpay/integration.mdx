...
DAFpay express checkout feature only works when DAFpay is listed at the top of a donation form (before the donor’s contact details are collected).
...
<Note>
  Submitting your own donation form before calling Chariot’s [Create Grant](/api-reference/grants/create) ensures consistency between your system and Chariot.
</Note>
...
<Note>
  Make sure to offer the ability for a donor to copy the tracking ID (including the "Tracking ID" prefix) directly on your confirmation page. 
</Note>
