...
<Error title="Avoid Asynchronous Actions">
...
After you submit your own donation form, do not forget to call the [Create Grant](/api-reference/grants/create) API to complete the transaction.
</Warning>
...
<Error>
  Submitting your own donation form before calling Chariot’s [Create Grant](/api-reference/grants/create) ensures consistency between your system and Chariot. See **Loading Screen** section below.
</Error>
...
<Tip title="Recurrence Is Not Managed By DAFpay"> 
