...
This section provides an introduction to Chariot Payments including the problem it attempts to solve, the concepts involved, and how it works.
...
In a sense, that's exactly what Chariot Payments does.
