...
<CardGroup cols={3}>
    <Card
        ...
        icon='user-plus'
    >
    Create a Chariot Payments Account
    </Card>
...
In most cases, you will need to provide Chariot with sufficient information to open and fund a bank account on your behalf.
