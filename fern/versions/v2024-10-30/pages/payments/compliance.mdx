...
<Alert>
Caution: Grant makers are required to make sure the grant is free from private benefit, does not fulfill an existing obligation & complies with all relevant IRS guidelines.
</Alert>
