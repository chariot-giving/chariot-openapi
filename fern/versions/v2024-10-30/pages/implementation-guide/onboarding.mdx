...
- [Create Nonprofit](/v2024-10-30/api/nonprofits/create): Call this route to create a nonprofit organization in our system using the organization’s EIN and email address
...
- [Create Connect](/v2024-10-30/api/connects/create): After creating the nonprofit, call this route using the `nonprofitId` to generate a Connect record, which will allow you to enable the DAFpay button on the nonprofit’s donation form.
...
### Claim Chariot Account
    - Upon calling the [Create Connect](/v2024-10-30/api/connects/create) route, Chariot will automatically email the nonprofit (using the email provided during nonprofit creation) with instructions on how to claim their Chariot account.
