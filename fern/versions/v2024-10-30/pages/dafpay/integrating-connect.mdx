...
After you submit your own donation form, don't forget to call the [Create Grant](/v2024-10-30/api/grants/create) API to complete the transaction.
...
3. Have your backend call Chariot's [Create Grant](/v2024-10-30/api/grants/create) API to complete the grant (and capture the grant intent).
...
After you submit your own donation form, don't forget to call the [Create Recurring Grant](/v2024-10-30/api/grants/create-recurring-grant) API to complete the transaction.
