...
<Warning>
  ...
  new refresh token returned in the response — a previously exchanged token
  fails as invalid. Serialize your refresh requests: concurrent exchanges can
  invalidate a token you just received.
</Warning>
