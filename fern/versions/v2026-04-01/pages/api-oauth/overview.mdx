...
| Scope                 | Grants                                                                                                                  |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `disbursements:read`  | Read and list disbursements and the transfers that fund them                                                            |
| `disbursements:write` | Create disbursements and transfers, approve, cancel, or stop them, and request verification of an unlisted organization |

Searching for and reading organizations requires no scope — those endpoints are public.

**Webhooks**

| Scope          | Grants                                  |
| -------------- | --------------------------------------- |
| `events:read`  | Read events and webhook subscriptions   |
| `events:write` | Create and update webhook subscriptions |
...
https://dashboard.givechariot.com/oauth/authorize
  ...
  &response_type=code
  &scope=openid%20disbursements:read%20disbursements:write
