...
<CardGroup cols={3}>
  ...
  Create a <Tooltip tip="Chariot is a financial technology company, not a bank. Chariot Accounts come with a Demand Deposit Account through our banking services partner, Column N.A., Member FDIC. Deposits in Chariot Accounts are eligible for FDIC insurance up to $250,000 per depositor, for each insurable capacity in which the account is held.">Chariot Deposit Account</Tooltip>
    </Card>
    ...
    <Card
        ...
        icon='bank'
    >
    Add funds to your <Tooltip tip="Chariot is a financial technology company, not a bank. Chariot Accounts come with a Demand Deposit Account through our banking services partner, Column N.A., Member FDIC. Deposits in Chariot Accounts are eligible for FDIC insurance up to $250,000 per depositor, for each insurable capacity in which the account is held.">Chariot Deposit Account</Tooltip>
    </Card>
        <Card
...
To get started with <Tooltip tip="Chariot is a financial technology company, not a bank. Chariot Accounts come with a Demand Deposit Account through our banking services partner, Column N.A., Member FDIC. Deposits in Chariot Accounts are eligible for FDIC insurance up to $250,000 per depositor, for each insurable capacity in which the account is held.">Chariot Disbursements</Tooltip>, you’ll need to register for an account with Chariot, open a Chariot Deposit Account, and go through the onboarding processes for both. 
