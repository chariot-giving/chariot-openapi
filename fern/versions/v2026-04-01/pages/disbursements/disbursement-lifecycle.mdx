...
Just-In-Time disbursements enable grantmakers to create and send disbursements without needing to pre-fund their <Tooltip tip="Chariot is a financial technology company, not a bank. Chariot Accounts come with a Demand Deposit Account through our banking services partner, Column N.A., Member FDIC. Deposits in Chariot Accounts are eligible for FDIC insurance up to $250,000 per depositor, for each insurable capacity in which the account is held.">Chariot Deposit Account</Tooltip>. When a disbursement with auto-funding enabled is approved, Chariot automatically creates an inbound transfer for the exact disbursement amount by immediately initiating an ACH debit.
...
<AccordionGroup>
    <Accordion title="In-Network Payments">
        Payments sent from one <Tooltip tip="Chariot is a financial technology company, not a bank. Chariot Accounts come with a Demand Deposit Account through our banking services partner, Column N.A., Member FDIC. Deposits in Chariot Accounts are eligible for FDIC insurance up to $250,000 per depositor, for each insurable capacity in which the account is held.">Chariot Deposit Account</Tooltip> to another Chariot Deposit Account can be made 24 hours a day, 7 days a week and, once approved, will settle instantly.
    </Accordion>
    <Accordion title="ACH">
