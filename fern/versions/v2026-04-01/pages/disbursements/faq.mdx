...
<AccordionGroup>
    <Accordion title="What if a nonprofit isn't listed on Chariot?">
        ...
        you can add it with [Create Organization](/api/organizations/create) to have Chariot's compliance team review and verify it.
        ...
        You can track the review by polling [Get Organization](/api/organizations/get) and reading `verification.status`,
        or by subscribing to `organization.updated` [webhook events](/api/webhooks).
