...
<Aside>
  ...
  - `payment_method.created`: This event is triggered when a payment method is created, whoever creates it: a submission through [Create a Payment Method](/api/payment-methods/create), a destination Chariot verifies for an organization, or a Chariot Deposit Account the organization opens.
  - `payment_method.updated`: This event is triggered when a payment method is updated. This happens when a submission is verified or rejected, or when an active destination becomes inactive.
</Aside>
