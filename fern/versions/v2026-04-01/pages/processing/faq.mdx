...
<AccordionGroup>
    ...
    <Accordion title="How do I transfer funds out to my external bank account?">
        Outbound transfer functionality is being finalized. Contact [support@givechariot.com](mailto:support@givechariot.com) for how to move funds to your external bank account today.
        {/* TODO(ENG-6126): replace once product confirms the payout flow */}
    </Accordion>
