...
- **[Donor-Initiated Verification](/guides/donor-accounts/account-lifecycle)** — The donor submits a grant first; DAFpay emails them a code which they pass to the DAF.
- **[DAF-Initiated Setup](/guides/donor-accounts/account-lifecycle)** — The DAF creates a Donor Account and token in advance and gives the code to the donor via their portal.
