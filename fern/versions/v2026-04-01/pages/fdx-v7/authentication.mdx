...
|-------------|----------|-------------|
| **Production** | `https://api.givechariot.com/bank/fdx/v7` | Separate client name and secret |
| **Staging** | `https://devapi.givechariot.com/bank/fdx/v7` | Separate client name and secret |
