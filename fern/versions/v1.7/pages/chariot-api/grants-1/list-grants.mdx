...
---
Returns a list of Grants that were created from an instance of [Connect](ref:get-connect). The `apiKey` from the Connect object should be passed in the `x-chariot-api-key` header for this request.
