...
If you don't want to use webhooks, or need to do some batch processing, you can also request Events from the Chariot API using the [List Events API](/v2023-01-01/api/events/list). Events will remain in the Chariot system for up to 30 days.
...
You can [Update an Event Subscription](/v2023-01-01/api/event-subscriptions/update) to change the event category for a webhook endpoint with the API.
