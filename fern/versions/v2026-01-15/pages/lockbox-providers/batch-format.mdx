...
| `mail_sent_to_department_code` | Department code within a shared PO box. Required if the mail item was sent to a department code. |          |
...
| `payment_amount` | Total payment amount in cents (e.g., `30000` for $300.00). **Must be non-zero if `check_number` is set.** | **Yes**  |
| `check_number`   | Check number                                                                                              | **Yes**  |
| `check_date`     | Date on the check in `MMddYYYY` format (e.g., `07012025` for July 1, 2025)                                | **Yes**  |
| `check_memo`     | Memo line from the check                                                                                  |          |
...
| `fund_name`           | The name of the donor's account in the DAF              |          | The Doe Family Fund                                                  |
| `donor_first_name`    | Donor's first name                                      |          | John                                                                 |
| `donor_last_name`     | Donor's last name                                       |          | Doe                                                                  |
| `donor_address_line1` | Donor's street address                                  |          | 123 Main St                                                          |
| `donor_address_line2` | Donor's address line 2                                  |          |                                                                      |
| `donor_address_city`  | Donor's city                                            |          | New York                                                             |
| `donor_address_state` | Donor's state                                           |          | NY                                                                   |
| `donor_address_zip`   | Donor's ZIP code                                        |          | 10001                                                                |
| `donor_email`         | Donor's email address                                   |          | john.doe@example.com                                                 |
| `purpose`             | Purpose of the grant                                    |          | General Operating Support                                            |
| `note`                | Additional notes or references                          |          | This grant is for the general operating support of the organization. |
...
| `mail_sent_to_po_box` | `mail_item_id` | `payment_method` | `payment_amount` | `check_number` | `check_date` | `check_memo` | `payer`           | `payee`            | `amount` | `fund_name`  | `donor_first_name` | `donor_last_name` | `donor_address_line1` | `donor_address_line2` | `donor_address_city` | `donor_address_state` | `donor_address_zip` | `donor_email`          | `purpose`                 | `note`                                                               |
| --------------------- | -------------- | ---------------- | ---------------- | -------------- | ------------ | ------------ | ----------------- | ------------------ | -------- | ------------ | ------------------ | ----------------- | --------------------- | --------------------- | -------------------- | --------------------- | ------------------- | ---------------------- | ------------------------- | -------------------------------------------------------------------- |
| 123 Main St PO Box 66 | mail_a1b2c3    | CHECK            | 18000            | 0002617986     | 12182024     | 8922058      | Schwab Charitable | Chai Lifeline Inc. | 18000    | DAFgiving360 | John Doe           | Doe               | 123 Main St           | _(empty)_             | New York             | NY                    | 10001               | john.doe@example.com   | General Operating Support | This grant is for the general operating support of the organization. |
| 123 Main St PO Box 66 | mail_a1b2c3    | CHECK            | 18000            | 0002617986     | 12182024     | 8922058      | Schwab Charitable | Chai Lifeline Inc. | 18000    | DAFgiving360 | Jane Smith         | Smith             | 123 Main St           | _(empty)_             | New York             | NY                    | 10001               | jane.smith@example.com | Program Support           | This grant is for the program support of the organization.           |
