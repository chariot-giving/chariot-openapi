...
|                                          |                                                                 |
| :-------------------------------------   | :------------------------------------------------------------------------------------------------------------------------------------------------ |
| Connect Configuration                    | Which donor-info fields the modal shows and requires, whether to allow monthly recurring gifts, and whether to [record unintegrated grant intents](/guides/dafpay/integrating-dafpay/integration#unintegrated-daf-providers) or return donors to your form |
