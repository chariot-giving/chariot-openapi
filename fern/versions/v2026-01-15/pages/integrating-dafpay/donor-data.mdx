...
That fill is called Express Checkout. It needs no setup, but it only works when the button sits above your contact fields. You can try it on the [demo page](https://secure.dafpay.com/demo) with the Express toggle on.
