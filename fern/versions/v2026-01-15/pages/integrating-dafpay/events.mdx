...
Two things we correct on most reviews.

**Don't say the gift is being processed.** DAFpay submits a grant request. The DAF provider decides on it and sends the money, usually one to two weeks later. "Processing your gift" tells the donor something is happening that isn't.
...
If you accept unintegrated grants, the confirmation page carries real work: see [Unconnected DAF Providers](/guides/dafpay/integrating-dafpay/unintegrated).
