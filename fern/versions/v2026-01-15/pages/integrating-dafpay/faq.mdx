...
<AccordionGroup>
    ...
    <Accordion title="How do nonprofits claim their accounts?">
        [Claiming your account with Chariot](https://help.givechariot.com/onboarding/onboarding-guide)
    </Accordion>
...
<AccordionGroup>
    <Accordion title="How can my platform collect our processing fees?">
        ...
        This will allow the caller to pass in a processing fee for the grant, in cents.
        ...
        Platform fees are only taken when the grant is successfully received by the nonprofit, and Chariot's fee plus your `applicationFeeAmount` cannot exceed 5% of the grant amount. Over that, the call returns `400 Bad Request`.
...
<AccordionGroup>
    ...
    <Accordion title="How can I run form validations before the DAFpay button launches?">
        ...
        Please see [Disabling Connect](/guides/dafpay/integrating-dafpay/donor-data#disabling-connect) to learn more.
    </Accordion>
