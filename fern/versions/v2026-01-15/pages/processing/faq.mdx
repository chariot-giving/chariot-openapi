...
<AccordionGroup>
    ...
    <Accordion title="How do I transfer funds out to my external bank account?">
        Outbound transfers are executed and managed through the [Chariot Dashboard](https://dashboard.givechariot.com) today, not the API. Nonprofits can initiate and track transfers to their external bank account directly from their dashboard.
    </Accordion>
