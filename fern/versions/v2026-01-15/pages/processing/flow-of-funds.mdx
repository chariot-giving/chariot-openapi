...
1. **Payment Source**: A DAF sponsor or fundraising platform initiates an ACH transfer to your Virtual Account
2. **Virtual Account Receipt**: Chariot receives the transfer at your designated Virtual Account's routing and account number
3. **Deposit Creation**: Chariot creates a Deposit record tracking the incoming transfer
...
6. **Settlement**: Check funds are deposited to your Chariot Deposit Account (3-5 business days)
...
- **Day 3-5**: Check funds settle to your account
...
Virtual Accounts enable you to segregate and track donations by source while maintaining a single Financial Account:
