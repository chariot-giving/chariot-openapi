...
For donations from Chariot-enabled grantmakers (using Chariot for Grantmakers):
...
<CardGroup cols={2}>
    <Card title='Create Source-Specific Payment Sources' icon='layer-group'>
    Use separate Payment Sources for each major payment source for easier tracking
    </Card>
