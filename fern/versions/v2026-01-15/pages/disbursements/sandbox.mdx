...
<Note title="Simulation coverage">
Simulation endpoints exist for **disbursements** and **inbound transfers**, the flows on this page. They do not cover donations or deposits. If you are testing DAFpay or Gift Processing, see [Sandbox Testing for nonprofits](/guides/nonprofits/sandbox).
</Note>
