...
| Scope            | Grants                                                                                       |
| ---------------- | -------------------------------------------------------------------------------------------- |
| `read:grants`    | Read and list grants and recurring grants                                                    |
| `create:grants`  | Create grants and recurring grants                                                           |
...
<Note>
  The consenting user's role must itself carry the permissions behind the scopes
  you request. A token only receives the permissions your client, the
  authorization, and the user's role all share, so a user with a read-only role
  who approves `create:grants` will receive read access only.
</Note>
