...
3. Have your backend call Chariot's [Create Grant](/v2023-01-01/api/grants/create) API to complete the grant (and capture the grant intent).

<Error>
  Submitting your own donation form before calling Chariot’s [Create Grant](/v2023-01-01/api/grants/create) ensures consistency between your system and Chariot. See **Loading Screen** section below.
</Error>
...
Unintegrated grants will be marked with an `unknown` status.
    - Use the [List Unintegrated Grants](/v2023-01-01/api/unintegrated-grants/list) API to access details such as gift amount, DAF provider name, and donor information.
...
After you submit your own donation form, don't forget to call the [Create Recurring Grant](/v2023-01-01/api/recurring-grants/create) API to complete the transaction.
